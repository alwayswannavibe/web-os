...
describe('calculatorLogic', () => {
  ...
  it('getCalcResult should work correctly if input is not correct', () => {
    const result = getCalcResult('1++2');

    expect(result).toEqual('Error');
  });

  it('getCalcResult should work correctly if result is nan', () => {
    const result = getCalcResult('0/0');

    expect(result).toEqual('Error');
  });

  it('getCalcResult should work correctly if input is only one plus', () => {
    const result = getCalcResult('1+2');

    expect(result).toEqual('3');
  });

  it('getCalcResult should work correctly if input is more than one pluses', () => {

...
describe('minesweeper slice', () => {
  ...
  describe('setMinesweeperDifficulty should work correctly', () => {
    it('setMinesweeperDifficulty should work correctly if difficulty is none', () => {
      ...
      testStore.dispatch(setMinesweeperDifficulty({ difficulty: Difficulties.None }));

      expect(testStore.getState().minesweeper.difficulty).toEqual(Difficulties.None);
    });
    ...
    it('setMinesweeperDifficulty should work correctly if difficulty is easy', () => {
      ...
      testStore.dispatch(setMinesweeperDifficulty({ difficulty: Difficulties.Easy }));

      expect(testStore.getState().minesweeper.difficulty).toEqual(Difficulties.Easy);
    ...
    it('setMinesweeperDifficulty should work correctly if difficulty is normal', () => {
      const testStore = configureStore({
        reducer: {
          minesweeper: minesweeperSlice,
        },
      ...
      testStore.dispatch(setMinesweeperDifficulty({ difficulty: Difficulties.Normal }));

      expect(testStore.getState().minesweeper.difficulty).toEqual(Difficulties.Normal);
    ...
    it('setMinesweeperDifficulty should work correctly if difficulty is hard', () => {
      const testStore = configureStore({
        reducer: {
          minesweeper: minesweeperSlice,
        },
      ...
      testStore.dispatch(setMinesweeperDifficulty({ difficulty: Difficulties.Hard }));

      expect(testStore.getState().minesweeper.difficulty).toEqual(Difficulties.Hard);
    ...
    it('setMinesweeperDifficulty should work correctly if difficulty is extreme', () => {
      const testStore = configureStore({
        reducer: {
          minesweeper: minesweeperSlice,
        },
      ...
      testStore.dispatch(setMinesweeperDifficulty({ difficulty: Difficulties.Extreme }));

      expect(testStore.getState().minesweeper.difficulty).toEqual(Difficulties.Extreme);
